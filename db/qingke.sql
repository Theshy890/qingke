...
CREATE TABLE `user_message` (
  ...
  `quote_content` varchar(500) DEFAULT NULL COMMENT '引用消息内容快照',
  `is_recalled` tinyint DEFAULT '0' COMMENT '是否撤回：0-否，1-是',
  `sender_deleted` tinyint DEFAULT '0' COMMENT '发送者已删除：0-否，1-是',
  `receiver_deleted` tinyint DEFAULT '0' COMMENT '接收者已删除：0-否，1-是',
  `is_read` tinyint DEFAULT '0' COMMENT '是否已读：0-未读，1-已读',
